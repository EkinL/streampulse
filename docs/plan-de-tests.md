...
| O-3 | `CORS_ALLOWED_ORIGINS=*` avec `AllowCredentials: true` dans la stack de dev | Acceptable en local, a restreindre en production | Documenter la valeur de prod dans `deployment.md` |
