...
/// Account list and role management: one of the two tabs of [AdminScreen].
/// No `Scaffold`/`AppBar` of its own - those live on the tabbed shell so the
/// two admin tabs don't each carry a redundant one.
